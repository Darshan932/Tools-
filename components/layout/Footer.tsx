      ...
      <div className="container mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-2 md:col-span-1">
            <Link href="/" className="flex items-center">
              <span className="text-xl font-bold text-primary-600 dark:text-primary-400">AI Tools</span>
            </Link>
            <p className="mt-4 text-sm text-gray-600 dark:text-gray-400">
              400+ useful AI tools for daily users across various categories including writing, design, productivity, and more.
            </p>
          </div>
        ...
        <div className="mt-12 border-t border-gray-200 dark:border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm text-gray-500 dark:text-gray-400">
            &copy; {currentYear} AI Tools. All rights reserved.
          </p>
